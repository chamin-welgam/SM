...
export class NzSelectComponent implements OnInit, AfterContentInit, AfterContentChecked, ControlValueAccessor {
  ...
  //SM > this variable does not affact the behavior, at the moment it does not do anything
  @Input()
  ...
  constructor(
    private _elementRef: ElementRef, private _renderer: Renderer2, private _locale: NzLocaleService) {
